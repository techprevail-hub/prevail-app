    ...
    <div className="bg-white min-h-screen p-8" style={{ fontFamily: "'Inter', 'Segoe UI', Arial, sans-serif", maxWidth: "850px", margin: "0 auto" }}>
      ...
      <div className="mb-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-1">
          {data.personal.fullName || "Daniel Jones"}
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed text-sm">
          {data.personal.summary || "Experienced and innovative Photographer bringing forth a true passion for capturing life's moments through a lens. Committed to the ultimate satisfaction of a client, and adept in using the most up-to-date photographic hardware and software."}
        </p>
      </div>
              ...
              <ul className="space-y-2">
                {data.skills.map((skill, idx) => (
                  <li key={idx} className="text-sm text-gray-700 flex items-start gap-2">
                    <span className="inline-block w-1.5 h-1.5 bg-gray-600 rounded-full mt-1.5 shrink-0"></span>
                    {skill}
                  </li>
                ))}
              </ul>
